...
- 개발자가 되기 전에는 웹 에이전시에서 웹 디자이너로 일을 하며 UI/UX에 관심이 많았지만, 지금은 개발에 푹 빠져있습니다.
- 무엇보다도 꾸준함의 가치를 중요시 하기 때문에 하루에 한번은 꼭 새롭게 알게 된 내용을 블로그에 정리를 하며 운영을 하고 있습니다.
- 끝없이 도전하고, 공부하며, 꾸준히 성장하는 개발자 이도형 입니다.
